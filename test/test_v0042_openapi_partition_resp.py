    ...
    def make_instance(self, include_optional) -> V0042OpenapiPartitionResp:
        ...
        if include_optional:
            return V0042OpenapiPartitionResp(
                partitions = [
                    openapi_slurm.models.v0/0/42_partition_info.v0.0.42_partition_info(
                ...
                last_update = openapi_slurm.models.v0/0/42_uint64_no_val_struct.v0.0.42_uint64_no_val_struct(
                    set = True,
                    infinite = True,
                    number = 56, ),
