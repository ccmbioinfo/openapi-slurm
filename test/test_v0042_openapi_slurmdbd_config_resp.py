    ...
    def make_instance(self, include_optional) -> V0042OpenapiSlurmdbdConfigResp:
        ...
        if include_optional:
            return V0042OpenapiSlurmdbdConfigResp(
                clusters = [
                    openapi_slurm.models.v0/0/42_cluster_rec.v0.0.42_cluster_rec(
                        ...
                        nodes = '',
                        select_plugin = '',
                        associations = openapi_slurm.models.v0_0_42_cluster_rec_associations.v0_0_42_cluster_rec_associations(
                            root = openapi_slurm.models.v0/0/42_assoc_short.v0.0.42_assoc_short(
                                account = '',
                                cluster = '',
                                partition = '',
                                user = '',
                ...
                users = [
                    openapi_slurm.models.v0/0/42_user.v0.0.42_user(
                        administrator_level = [
                            'Not Set'
                            ],
                        associations = [
                        ...
                        old_name = '',
                        wckeys = [
                            openapi_slurm.models.v0/0/42_wckey.v0.0.42_wckey(
                                accounting = [
                ...
                qos = [
                    openapi_slurm.models.v0/0/42_qos.v0.0.42_qos(
                        description = '',
                        flags = [
                            'NOT_SET'
                            ],
                        id = 56,
                        limits = openapi_slurm.models.v0_0_42_qos_limits.v0_0_42_qos_limits(
                            grace_time = 56,
                            max = openapi_slurm.models.v0_0_42_qos_limits_max.v0_0_42_qos_limits_max(
                                active_jobs = openapi_slurm.models.v0_0_42_qos_limits_max_active_jobs.v0_0_42_qos_limits_max_active_jobs(
                                    ...
                                    count = openapi_slurm.models.v0/0/42_uint32_no_val_struct.v0.0.42_uint32_no_val_struct(
                                        ...
                                        infinite = True,
                                        number = 56, ), ),
                                jobs = openapi_slurm.models.v0_0_42_qos_limits_max_jobs.v0_0_42_qos_limits_max_jobs(
                                    per = openapi_slurm.models.v0_0_42_qos_limits_max_jobs_active_jobs_per.v0_0_42_qos_limits_max_jobs_active_jobs_per(
                                        account = ,
                                        user = , ), ),
                                tres = openapi_slurm.models.v0_0_42_qos_limits_max_tres.v0_0_42_qos_limits_max_tres(
                                    total = [
                                        openapi_slurm.models.v0/0/42_tres.v0.0.42_tres(
                                            type = '',
                                            name = '',
                                    ...
                                    minutes = openapi_slurm.models.v0_0_42_qos_limits_max_tres_minutes.v0_0_42_qos_limits_max_tres_minutes(), ),
                                wall_clock = openapi_slurm.models.v0_0_42_qos_limits_max_wall_clock.v0_0_42_qos_limits_max_wall_clock(),
                                accruing = openapi_slurm.models.v0_0_42_qos_limits_max_jobs_active_jobs.v0_0_42_qos_limits_max_jobs_active_jobs(), ),
                            factor = openapi_slurm.models.v0/0/42_float64_no_val_struct.v0.0.42_float64_no_val_struct(
                                set = True,
                                infinite = True,
                                number = 1.337, ),
                            min = openapi_slurm.models.v0_0_42_qos_limits_min.v0_0_42_qos_limits_min(
                                priority_threshold = , ), ),
                        name = '',
                        preempt = openapi_slurm.models.v0_0_42_qos_preempt.v0_0_42_qos_preempt(
                            list = [
                                ''
                                ],
                            mode = [
                            ...
                            exempt_time = , ),
                        priority = ,
                        usage_factor = openapi_slurm.models.v0/0/42_float64_no_val_struct.v0.0.42_float64_no_val_struct(
                            set = True,
                            infinite = True,
                            number = 1.337, ),
                        usage_threshold = , )
                ...
                associations = [
                    openapi_slurm.models.v0/0/42_assoc.v0.0.42_assoc(
                        accounting = [
                            openapi_slurm.models.v0/0/42_accounting.v0.0.42_accounting(
                                allocated = openapi_slurm.models.v0_0_42_accounting_allocated.v0_0_42_accounting_allocated(
                                    seconds = 56, ),
                ...
                instances = [
                    openapi_slurm.models.v0/0/42_instance.v0.0.42_instance(
                        cluster = '',
                        extra = '',
                        instance_id = '',
                        instance_type = '',
