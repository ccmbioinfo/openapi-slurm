    ...
    def make_instance(self, include_optional) -> V0043OpenapiUsersAddCondResp:
        ...
        if include_optional:
            return V0043OpenapiUsersAddCondResp(
                association_condition = openapi_slurm.models.v0/0/43_users_add_cond.v0.0.43_users_add_cond(
                    accounts = [
                        ''
                        ],
                    ...
                    users = ,
                    wckeys = , ),
                user = openapi_slurm.models.v0/0/43_user_short.v0.0.43_user_short(
                    adminlevel = [
                        'Not Set'
                        ],
                    defaultaccount = '',
