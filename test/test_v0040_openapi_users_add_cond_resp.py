    ...
    def make_instance(self, include_optional) -> V0040OpenapiUsersAddCondResp:
        ...
        if include_optional:
            return V0040OpenapiUsersAddCondResp(
                association_condition = openapi_slurm.models.v0/0/40_users_add_cond.v0.0.40_users_add_cond(
                    accounts = [
                        ''
                        ],
                    ...
                    users = ,
                    wckeys = , ),
                user = openapi_slurm.models.v0/0/40_user_short.v0.0.40_user_short(
                    adminlevel = [
                        'Not Set'
                        ],
                    defaultaccount = '',
