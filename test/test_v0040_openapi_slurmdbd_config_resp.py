    ...
    def make_instance(self, include_optional) -> V0040OpenapiSlurmdbdConfigResp:
        ...
        if include_optional:
            return V0040OpenapiSlurmdbdConfigResp(
                ...
                accounts = [
                    openapi_slurm.models.v0/0/40_account.v0.0.40_account(
                        associations = [
                ...
                users = [
                    openapi_slurm.models.v0/0/40_user.v0.0.40_user(
                        administrator_level = [
                            'Not Set'
                            ],
                        associations = [
                ...
                qos = [
                    openapi_slurm.models.v0/0/40_qos.v0.0.40_qos(
                        description = '',
                        flags = [
                            'NOT_SET'
                            ],
                        id = 56,
                        limits = openapi_slurm.models.v0_0_40_qos_limits.v0_0_40_qos_limits(
                            grace_time = 56,
                            ...
                            min = openapi_slurm.models.v0_0_40_qos_limits_min.v0_0_40_qos_limits_min(
                                priority_threshold = , ), ),
                        name = '',
                        preempt = openapi_slurm.models.v0_0_40_qos_preempt.v0_0_40_qos_preempt(
                            list = [
                                ''
                                ],
                            mode = [
                            ...
                            exempt_time = , ),
                        priority = ,
                        usage_factor = openapi_slurm.models.v0/0/40_float64_no_val.v0.0.40_float64_no_val(
                            set = True,
                            infinite = True,
                            number = 1.337, ),
                        usage_threshold = , )
                ...
                associations = [
                    openapi_slurm.models.v0/0/40_assoc.v0.0.40_assoc(
                        accounting = [
                            openapi_slurm.models.v0/0/40_accounting.v0.0.40_accounting(
                                allocated = openapi_slurm.models.v0_0_40_accounting_allocated.v0_0_40_accounting_allocated(
                                    seconds = 56, ),
                        ...
                        max = openapi_slurm.models.v0_0_40_assoc_max.v0_0_40_assoc_max(
                            jobs = openapi_slurm.models.v0_0_40_assoc_max_jobs.v0_0_40_assoc_max_jobs(
                                per = openapi_slurm.models.v0_0_40_assoc_max_jobs_per.v0_0_40_assoc_max_jobs_per(
                                    count = openapi_slurm.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                                        set = True,
                                        infinite = True,
                                        number = 56, ),
                                ...
                                accruing = ,
                                total = , ),
                            tres = openapi_slurm.models.v0_0_40_assoc_max_tres.v0_0_40_assoc_max_tres(
                                group = openapi_slurm.models.v0_0_40_assoc_max_tres_group.v0_0_40_assoc_max_tres_group(
                                    minutes = [
                                        openapi_slurm.models.v0/0/40_tres.v0.0.40_tres(
                                            type = '',
                                            name = '',
                                ...
                                minutes = openapi_slurm.models.v0_0_40_assoc_max_tres_minutes.v0_0_40_assoc_max_tres_minutes(), ),
                            per = openapi_slurm.models.v0_0_40_assoc_max_per.v0_0_40_assoc_max_per(
                                account = openapi_slurm.models.v0_0_40_assoc_max_per_account.v0_0_40_assoc_max_per_account(), ), ),
                        id = openapi_slurm.models.v0/0/40_assoc_short.v0.0.40_assoc_short(
                            cluster = '',
                            partition = '',
                            user = '', ),
                        is_default = True,
                        lineage = '',
                        min = openapi_slurm.models.v0_0_40_assoc_min.v0_0_40_assoc_min(
                            priority_threshold = , ),
                        parent_account = '',
                        partition = '',
                        priority = ,
