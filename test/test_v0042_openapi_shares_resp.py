    ...
    def make_instance(self, include_optional) -> V0042OpenapiSharesResp:
        ...
        if include_optional:
            return V0042OpenapiSharesResp(
                shares = openapi_slurm.models.v0/0/42_shares_resp_msg.v0.0.42_shares_resp_msg(
                    shares = [
                        openapi_slurm.models.v0/0/42_assoc_shares_obj_wrap.v0.0.42_assoc_shares_obj_wrap(
                            id = 56,
                            cluster = '',
                            name = '',
                            parent = '',
