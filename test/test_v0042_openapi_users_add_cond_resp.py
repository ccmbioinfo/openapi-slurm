    ...
    def make_instance(self, include_optional) -> V0042OpenapiUsersAddCondResp:
        ...
        if include_optional:
            return V0042OpenapiUsersAddCondResp(
                association_condition = openapi_slurm.models.v0/0/42_users_add_cond.v0.0.42_users_add_cond(
                    accounts = [
                        ''
                        ],
                    ...
                    users = ,
                    wckeys = , ),
                user = openapi_slurm.models.v0/0/42_user_short.v0.0.42_user_short(
                    adminlevel = [
                        'Not Set'
                        ],
                    defaultaccount = '',
